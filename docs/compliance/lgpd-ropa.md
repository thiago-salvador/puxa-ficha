...
2. **Canal de direitos do titular**: definido como privacidade@puxaficha.com.br. Procedimento documentado em `docs/compliance/lgpd-incident-playbook.md`. Pendente: criar o email no provedor.
