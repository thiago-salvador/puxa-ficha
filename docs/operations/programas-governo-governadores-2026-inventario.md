...
O manifesto canônico é `docs/reviews/programas-governo-governadores-2026/publicacao-2026-09-06.json`, que sucede o de 3 de setembro. Além de Eduardo Paes e Vera Lúcia, Ben Mendes saiu de `unavailable` para `approved` depois que o pacote oficial de MG passou a conter seu programa. Ele registra os mesmos 194 perfis publicáveis, agora 192 programas aprovados e dois perfis com `sem_documento_oficial`, sem `human_review_required`. A auditoria de publicados passa com 192 registros aprovados em 27 UFs, 2.449 claims e 14.694 itens de Eval. As duas inscrições oficiais de Laudicério permanecem excluídas em `quarantine_duplicate_active`; os registros terminais de Cleber Rabelo e Pedro Brito foram removidos da superfície e preservados em backup datado.
