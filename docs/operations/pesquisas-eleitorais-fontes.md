...
Consultado em: `2026-08-24T19:07:12-03:00`

## Decisão para o piloto

O conjunto preferencial das fichas é fechado em Datafolha, AtlasIntel e Ipsos-Ipec. A publicação exige, para cada instituto, uma rodada nacional presidencial atual, registro compatível no TSE, divulgação pública, metodologia identificável, status `aprovado` e o mesmo escopo de comparabilidade. Outro instituto aprovado no scorecard não substitui uma fonte preferencial ausente.

Na revisão atual, somente Datafolha atende a todos os gates e aparece nas fichas. AtlasIntel continua `condicional`: o PesqEle confirma financiamento próprio, mas há diferença entre 5.000 entrevistas registradas e 5.021 respondentes divulgados, além de não haver trilha pública específica de correções. Ipsos-Ipec permanece ausente: a última rodada nacional localizada é de dezembro de 2025 e a publicação atual de agosto de 2026 mede o Ceará, geografia incompatível com a ficha nacional.
...
| `atlasintel-bloomberg-nacional-2026` | condicional | AtlasIntel | AtlasIntel Tecnologia de Dados Ltda., recursos próprios | AtlasIntel | TSE `BR-08602/2026` | [Relatório Atlas/Bloomberg, 29/07/2026](https://cdn.atlasintel.org/498dd172-4381-4192-977c-c4af9787434f.pdf) | true | true | false | true | true | O PesqEle confirma contratante e financiamento. Permanecem sem resolução a diferença entre 5.000 entrevistas registradas e 5.021 respondentes divulgados e a ausência de trilha pública específica de correções. A rodada não é publicada. |
...
| `ipsos-ipec-nacional-2026` | excluído | Ipsos-Ipec | Ipsos-Ipec | Ipsos | TSE/PesqEle, exigido por rodada nacional de 2026 | [Ipsos, índice de eleições](https://www.ipsos.com/pt-br/topic/eleicoes) | true | true | false | true | true | A última rodada nacional localizada é de [10/12/2025](https://www.ipsos.com/pt-br/lula-lidera-hoje-todos-os-cenarios-testados-para-eleicoes-de-2026). A publicação de [20/08/2026](https://www.ipsos.com/pt-br/campanha-eleitoral-do-ceara-comeca-com-ciro-gomes-liderando-a-disputa-pelo-governo) mede o Ceará e não pode preencher o escopo nacional. |
