...
describe("classificador puro (#136)", () => {
  ...
  test("o gate de replay real existe e compara conjunto, não só posição (rodada 3)", () => {
    ...
    // Issues #378 e #383 (18/09/2026): duas migrations de dado, sem DDL, cada
    ...
    // Historico federal e nome civil (20260925230000/0100), depois do #502: --gate PG17 mediu 409 + 105 = 514.
    assert.equal(manifesto.aplicadas_esperadas, 409)
