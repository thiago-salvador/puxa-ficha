...
test("running mates require a unique confirmed link in the requested election and scope", async () => {
...
test("presidential running mates accept national scope without turning absent data into names", async () => {
  const { selectProgramRunningMates, loadProgramRunningMates } = await import("../src/lib/program-running-mates")
