...
import { normalizeContradictionText } from "./contradiction-utils"
...
export function isContradictionAttentionCategory(categoria: string | null | undefined): boolean {
  const normalized = normalizeContradictionText(categoria).replace(/[_-]+/g, " ")
  return normalized === "contradicao" || normalized === "mudanca posicao"
}
