...
export async function GET(request: Request) {
  try {
    ...
    return new Response(body, { status: 200, headers: exportHeaders(csv ? "text/csv; charset=utf-8" : "application/json; charset=utf-8", csv ? "puxa-ficha-imprensa-processos.csv" : "puxa-ficha-imprensa-processos.json", dataset) })
  } catch (error) {
