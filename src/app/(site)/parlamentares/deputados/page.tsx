...
const title = "Deputados | Puxa Ficha"
const description =
  "O Puxa Ficha amplia a consulta parlamentar por etapas, com fichas públicas baseadas em fontes verificáveis."

export const metadata: Metadata = {
  title,
  description,
  alternates: {
    canonical: "/parlamentares/deputados",
  },
  openGraph: {
    title,
    description,
    url: "https://puxaficha.com.br/parlamentares/deputados",
    images: [
      {
        url: "/opengraph-image",
        width: 1200,
        height: 630,
        alt: "Deputados | Puxa Ficha",
      },
    ],
  },
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="mx-auto max-w-7xl px-5 py-8 sm:py-12 md:px-12 lg:py-16">
        <p className="mb-8 text-sm font-semibold uppercase tracking-[0.12em] text-muted-foreground">
          <Link href="/parlamentares" className={linkClass}>← Parlamentares</Link>
        </p>
        ...
        <div className={`mt-6 max-w-2xl space-y-5 sm:mt-8 ${prose}`}>
          <p>O Puxa Ficha amplia a consulta parlamentar por etapas. As fichas de deputados seguem em preparação.</p>
          <p>
          ...
          <p>
            O desafio é a escala. Somados, esses dois cargos reúnem <strong>18.717 registros de candidatura</strong>:
          </p>
          <ul className={listClass}>
            <li><strong>11.090</strong> para deputado estadual;</li>
            <li><strong>7.627</strong> para deputado federal.</li>
          </ul>
          ...
          <p>
            Não basta gerar mais de 18 mil páginas automaticamente. É preciso distinguir pessoas com
          ...
          <p><strong>Informação política errada também desinforma.</strong></p>
          <p>
      ...
      <section className="mx-auto max-w-7xl px-5 py-8 sm:py-12 md:px-12 lg:py-16">
        ...
        <div className={`mt-6 max-w-2xl space-y-5 sm:mt-8 ${prose}`}>
          ...
          <p>
            <strong>Antes de votar, puxe a ficha. Ajude a garantir que isso também seja possível para deputados.</strong>
          </p>
        </div>
      </section>
