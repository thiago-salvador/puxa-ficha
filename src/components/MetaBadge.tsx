...
export function MetaBadge({
  ...
  return (
    <span
      ...
      className={cn(
        "inline-flex min-h-[28px] min-w-0 max-w-full shrink-0 items-center whitespace-normal rounded-full border px-2.5 py-1 text-[length:var(--text-caption)] font-bold uppercase leading-tight tracking-[0.05em] [overflow-wrap:anywhere]",
