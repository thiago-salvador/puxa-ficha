    ...
    >
      <div className="relative min-w-[190px]">
        <Combobox.Input
          ...
          className="h-11 w-full rounded-full border border-foreground bg-transparent px-4 pr-16 text-base font-semibold uppercase tracking-[0.05em] text-foreground outline-none transition-colors placeholder:text-foreground/60 focus-visible:ring-2 focus-visible:ring-foreground/50 focus-visible:ring-offset-2 focus-visible:ring-offset-background md:h-10 md:text-[length:var(--text-caption)]"
