...
const ESPECTRO_PARTIDARIO: EspectroPartidario[] = [
  ...
  { partido_sigla: "UNIÃO", eixo_economico: 6, eixo_social: 6, fonte: "curadoria" },
  {
  ...
  },
  {
    ...
    fonte: "curadoria",
    notas:
      "DADOS 2023 (survey 2018, predecessors PTB/Patriota) + espectro-partidos.json onda-p 14/08",
  },
  { partido_sigla: "PRTB", eixo_economico: 7, eixo_social: 8, fonte: "curadoria" },
  { partido_sigla: "MISSÃO", eixo_economico: 5, eixo_social: 8, fonte: "curadoria" },
]
