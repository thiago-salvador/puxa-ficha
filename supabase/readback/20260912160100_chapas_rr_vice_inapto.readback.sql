BEGIN READ ONLY;
DO $readback$ BEGIN
IF (SELECT count(*) FROM public.chapas_2026 WHERE chave='2026:RR:jose-clebio-genuino-do-nascimento' AND titular_sq_candidato='230002553857'
