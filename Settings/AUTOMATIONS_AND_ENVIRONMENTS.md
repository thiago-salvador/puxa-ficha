...
| `CHECAGENS_SLUGS` | Recorte opcional da busca nominal de checagens (`checagens-coleta.yml`) | Derivada do input `slugs` do disparo manual; vazia na execução agendada, que cobre o cadastro inteiro. | GitHub workflow |
