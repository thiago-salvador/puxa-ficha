...
export const MEDICAO_REPLAY = Object.freeze({
  ...
  // 91 -> 92 em 02/09/2026: a 20260903100100 (CHECK do vocabulario de
  ...
  // 104 -> 110 no release do Senado (16/09/2026): seis migrations aditivas de
  // DDL pura entram no replay de schema (20260914000000, 20260915090000,
  ...
  // 111 -> 112 em 16/09/2026 (issue #340): 20260916130000 alarga o CHECK de
  // situacao_candidatura para 'pendente de julgamento' (DDL pura); a
  // 20260916140000 que segue é curadoria (UPDATE de candidatos e chapas_2026)
