...
const allowed = new Set([
  ...
  "docs/operations/pesquisas-monitoramento-live-proof.json",
  "package.json",
  "scripts/audit/audit-pesquisas-monitoramento.ts",
  "scripts/audit/verify-pesquisas-monitoramento-live-proof.mjs",
  ...
  "scripts/lib/pesquisas-monitoramento-reconciliacoes.ts",
  ...
  "tests/fixtures/pesquisas-monitoramento/datafolha-nacional-publicacao.html",
  "tests/fixtures/pesquisas-monitoramento/datafolha-estadual-publicacao.html",
  "tests/fixtures/pesquisas-monitoramento/datafolha-estadual-amostra-intercalada.html",
  "tests/fixtures/pesquisas-monitoramento/poderdata-publicacao.html",
  "tests/fixtures/pesquisas-monitoramento/real-time-big-data-publicacao.html",
  ...
  "tests/pesquisas-reconciliacoes.test.ts",
