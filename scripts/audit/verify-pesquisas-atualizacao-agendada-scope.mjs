...
const allowedExact = new Set([
  ...
  "scripts/lib/pesquisas-monitoramento-entrada.ts",
  "scripts/lib/pesquisas-monitoramento-descoberta.ts",
  "tests/pesquisas-descoberta-registros.test.ts",
  "tests/pesquisas-publication-receipts.test.ts",
  "scripts/lib/pesquisas-monitoramento-realtime-pdf.ts",
  "scripts/lib/pesquisas-monitoramento-realtime-pa-pdf.ts",
  "scripts/lib/pesquisas-monitoramento-realtime-rs-pdf.ts",
  "scripts/lib/pesquisas-monitoramento-identidades-revisadas.ts",
  "scripts/pesquisas-monitoramento.ts",
  "tests/pesquisas-entrada.test.ts",
  "tests/fixtures/pesquisas-monitoramento/pesqele-br-04029-receipt.json",
  ...
  "tests/pesquisas-realtime-rs-pdf.test.ts",
  "tests/pesquisas-r2.test.ts",
  "tests/pesquisas-s0.test.ts",
