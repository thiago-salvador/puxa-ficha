#!/usr/bin/env bash
# Aplica somente a migration de correção das fontes da issue #424.
set -euo pipefail
...
previous_version=20260922150000
...
print("BEGIN;")
print("SELECT pg_advisory_xact_lock(hashtextextended('puxa-ficha:issue-424-production', 0));")
...
print("    RAISE EXCEPTION 'issue #424: ledger divergiu sob lock';")
print("  END IF;")
print("END $ledger$;")
...
print("    RAISE EXCEPTION 'issue #424: ledger final divergiu';")
print("  END IF;")
print("END $ledger$;")
print("COMMIT;")
PY
