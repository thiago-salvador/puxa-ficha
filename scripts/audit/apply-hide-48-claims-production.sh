#!/usr/bin/env bash
# Aplica somente a migration que despublica 48 claims com fontes defeituosas.
set -euo pipefail
...
version=20260923001140
previous_version=20260922160000
...
print("BEGIN;")
print("SELECT pg_advisory_xact_lock(hashtextextended('puxa-ficha:hide-48-claims-production', 0));")
...
print("    RAISE EXCEPTION 'hide-48 claims: ledger divergiu sob lock';")
print("  END IF;")
print("END $ledger$;")
...
print("    RAISE EXCEPTION 'hide-48 claims: ledger final divergiu';")
print("  END IF;")
print("END $ledger$;")
print("COMMIT;")
PY
