...
const EXACT = new Set([
  ...
  "scripts/lib/data-freshness/tse-dependent-monitors.ts",
  "scripts/lib/programas-governo-extracao.ts",
  "scripts/lib/programas-governo-recibos-ausencia.ts",
  "scripts/lib/programas-governo-multipassagem.ts",
  "scripts/lib/programas-governo-opencode-runner.mjs",
  "scripts/lib/programas-governo-prompt.d.mts",
  "scripts/lib/programas-governo-prompt.mjs",
  ...
  "src/data/programas-governo-governadores-2026.ts",
  ...
  "tests/programa-governo-anuncio.test.tsx",
  ...
  "tests/programa-governo-governadores-batch-novos.test.ts",
  "tests/programa-governo-governadores-reprocessar-duvidas.test.mjs",
