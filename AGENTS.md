...
- workflow editorial de `pontos_atencao` ainda incompleto; itens de IA exigem revisao humana e nao devem entrar na superficie publica antes de `verificado = true`
